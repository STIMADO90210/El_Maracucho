...
{	
	$cate=$cat->edit_categoria($_POST['categoria'],$_POST['id']);
	exit;
}
$cate=$cat->get_categoria_id($_GET['id']);
?>
...
<br>
      ...
      <div class="container">
      		<form class="form-control" action="edita_cat.php" method="post">
            	<div class="form-group">
            		<input class="form-control color-gris text-white" name="categoria" type="text" value="<?php echo $cate[0]['categoria'] ?>">					                    
                </div>    
